...
CREATE TABLE "FactLoginAttempts" (
...
ALTER TABLE "FactLoginAttempts" ADD FOREIGN KEY ("customer_id") REFERENCES "DimCustomer" ("customer_id");
...
ALTER TABLE "FactCustomerActivity" ADD FOREIGN KEY ("login_attempt_id") REFERENCES "FactLoginAttempts" ("login_attempt_id");
